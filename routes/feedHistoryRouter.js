...
feedHistoryRouter.get("/all/month-year", verifyToken.verifyToken, feedHistoryController.getEntriesByMonthYear )
feedHistoryRouter.get("/all/year", verifyToken.verifyToken, feedHistoryController.getEntriesByYear )
